...
public class MongoDBConnection {
    ...
    private static final String USERNAME = "santosvieirafelipe_db_user";
    private static final String PASSWORD = "bn4hT2ahGmlEmyq9";
    private static final String CLUSTER_URL = "cluster0.pks6zwr.mongodb.net"; // Substitua pelo seu cluster se for diferente
    ...
    public static void main(String[] args) {
        ...
        UsuarioOperations usuarios = new UsuarioOperations(connection.getDatabase().getCollection("usuarios"));
        usuarios.operations();
        try {
